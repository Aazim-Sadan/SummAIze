...
const steps: Step[] = [
    {
        ...
        description: 'Simply drag and drop your PDF document or click to uplaod'
    },
    {
        icon: <BrainCircuit size={64} strokeWidth={1.5} />,
        label: 'AI Analysis',
        description: 'Recieve a cocise summary of your document in seconds'
    },
    {
        icon: <FileOutput size={64} strokeWidth={1.5} />,
        label: 'Get Summary',
        description: 'Recieve a clear, cocise summary of your document'
    },
]
        ...
        <section className='relative overflow-hidden bg-gray-50'>
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className='text-center mb-16'>
                    <h2 className='font-bold text-xl uppercase mb-4 text-rose-500 '>How it works
                    </h2>
