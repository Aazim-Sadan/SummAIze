...
export default function LoadingSkeleton() {
    return (
        <Card className="relative px-2 h-[700px] w-[600px] max-w-lg mx-auto overflow-hidden bg-gradient-to-br from-background via-background/90 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
            ...
            <div className="h-full overflow-y-auto scroller-hide pt-16 pb-24">
                <div className="px-6">
                    {/* Loading Title */}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xs border-t border-rose-500/10">
                <div className="flex justify-center items-center gap-4">
                    <Skeleton className="rounded-full w-12 h-12 bg-gradient-to-r from-rose-500/50 to-rose-600/50" />
